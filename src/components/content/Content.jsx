export default function Content(){
    return (
        <div className="w-full h-[24rem] border-b border-slate-300" >
            
            <div className="absolute text-gray-600 right-1/2 translate-x-1/2 text-left items-center md:w-[50rem] mt-14 w-[20rem]">
                ...
                <div className="sm:w-[460px] flex text-white text-sm gap-x-5 mt-10 ml-[50%] translate-x-[-50%]">
